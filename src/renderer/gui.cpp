...
void GUI::setupGUI()
{
	...
	if (ImGui::BeginMainMenuBar())
	{
		...
		{
			if (ImGui::MenuItem("Launch OCL Kernel"))
			{
				interfaceOCL.renderOCL(renderWidth, renderHeight, renderSamples, renderBounces);
			}
...
void GUI::setOCL(OCL* rendererOCL)
{
	interfaceOCL = *rendererOCL;
}
